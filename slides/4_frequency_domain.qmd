...
subtitle: "Multi-agent system for smart machining, part I-e"
...
- with **sliding window** approach to continuously update the features as new data arrives, reducing the computational load but with a potentially higher latency in feature updates
...
# Exercises
Look at the [exercise notebook](/notebooks/exercise_04.qmd){target="_blank"} for exercises on frequency domain analysis in R, Python, and MongoDB.