...
subtitle: "Multi-agent system for smart machining, part I-a"
...
# Distributed data acquisition and processing in practice

## MADS: Multi-Agent Distributed System

::: {.columns}
::: {.column}
The **Multi-Agent Distributed System** (MADS) is a lightweight and modular software framework for distributed data acquisition and processing

General purpose, but well-suited for smart manufacturing environments
:::
::: {.column .noicons}
  <a href="https://github.com/pbosetti/MADS" target="_blank" rel="noopener noreferrer">
    <img
      src="https://opengraph.githubassets.com/MADS-preview/pbosetti/MADS"
      alt="MADS GitHub repository preview"
...
::: {.callout-important}
### Where to start
Go to [mads-net-github.io](https://mads-net-github.io/) for documentation, examples, and tutorials on how to use MADS for distributed data acquisition and processing
:::